...
public class SearchStrategies {
    ...
    //EXPLANATION SearchStrategies udnytter et strategy pattern til at søge efter en node.
    //EXPLANATION Der bliver brugt to strategier til at løse samme problem searchBFS (bredde først) searchDFS (dybde først) Begge algoritmer kan skiftes ved runtime
    ...
    public static void main(String[] args) {
        ...
        Node foundBFS = searchBFS("E", A); //NOTE Her bruges den første strategi
        if (foundBFS != null) {
        ...
        Node foundDFS = searchDFS("E", A); //NOTE Her bruges den anden strategi
        if (foundDFS != null) {
